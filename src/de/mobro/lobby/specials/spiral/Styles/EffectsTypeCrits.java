...
public class EffectsTypeCrits{

    private int taskID;
    private final Player player;

    public EffectsTypeCrits(Player player){
        this.player = player;
    }
    ...
    public void startSpiral(){
        ...
        taskID = Bukkit.getScheduler().scheduleSyncRepeatingTask(Main.getPlugin(Main.class), new Runnable() {
            ...
            public void run() {
                ...
                ParticleUtils particle = new ParticleUtils(EnumParticle.CRIT, first, true, 0f, 0f, 0f, 0, 7);
                particle.sendAll();
                ParticleUtils particle2 = new ParticleUtils(EnumParticle.CRIT_MAGIC, second, true, 0f, 0f, 0f, 0, 7);
                particle2.sendAll();
            }
        }, 0, 1);
    }
